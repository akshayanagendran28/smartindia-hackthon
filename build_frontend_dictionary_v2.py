# -*- coding: utf-8 -*-
"""
Generate complete 11-Language Samanantar + English UI translations in LanguageContext.jsx (V2)
"""
import os
import json
...
export const SCHEME_MAP = {
  ...
  MUDRA_SHISHU: {
    ...
    te: { name: "పీఎం ముద్రా యோజన - శిశు (₹50,000 వరకు)", desc: "చిన్న వ్యాపారాల కోసం ₹50,000 వరకు పూచీకత్తు లేని సూక్ష్మ రుణం." },
...
print("LanguageContext.jsx (V2) updated successfully!")
