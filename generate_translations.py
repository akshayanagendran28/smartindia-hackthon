# -*- coding: utf-8 -*-
"""
Full Translation Generator for all 11 AI4Bharat Samanantar Indian Languages + English
"""
import os
import json
...
class SamanantarIndicTranslationService:
    ...
    DOMAIN_LEXICON = {
        ...
        "capital subsidy": {
            "hi": "पूंजीगत अनुदान (कैपिटल सब्सिडी)", "ta": "மூலதன மானியம்", "te": "మూలధන సబ్సిడీ", "kn": "ಬಂಡವಾಳ ಸಬ್ಸಿಡಿ", "ml": "മൂലധന സബ്‌സിഡി",
            "mr": "भांडवली अनुदान", "bn": "মূলধন ভর্তুকি", "gu": "મૂડી સબસિડી", "pa": "ਪੂੰਜੀ ਸਬਸਿਡੀ", "or": "ପୁଞ୍ଜି ରିହାତି", "as": "মূলধন ৰাজসাহায্য"
        },
        "interest subvention": {
            "hi": "ब्याज दर छूट / अनुदान", "ta": "வட்டி மானியம்", "te": "வడ్డీ రాయితీ", "kn": "ಬಡ್ಡಿ ರಿಯಾಯಿತಿ", "ml": "പലിശ ഇളവ്",
        ...
        "traditional artisan": {
            "hi": "पारंपरिक कारीगर व शिल्पकार", "ta": "பாரம்பரிய கைவினைஞர்", "te": "సాంప్రదాయ కళాకారుడు", "kn": "ಸಾಂಪ್ರದಾಯಿಕ ಕುಶಲಕರ್ಮಿ", "ml": "പരമ്പരാഗത കരകൗശല വിദഗ്ദ്ധൻ",
        ...
        "urban area": {
            "hi": "शहरी क्षेत्र", "ta": "நகர்ப்புற பகுதி", "te": "పట్టణ ప్రాంతం", "kn": "ನಗರ ಪ್ರದೇಶ", "ml": "നഗರ ಪ್ರദേശം",
    ...
    EXPLAINABILITY_CORPUS = {
        "Your annual family income falls comfortably within scheme eligibility guidelines.": {
            ...
            "as": "আপোনাৰ বাৰ্ষিক পাৰিবাৰিক আয় আঁচনিৰ योग्यताৰ ভিতৰত আছে।"
        },
...
with open(r'C:\Users\aksha\.gemini\antigravity\scratch\scheme-sathi\backend\app\services\indic_translation.py', 'w', encoding='utf-8') as f:
    f.write(indic_code)
print("Updated indic_translation.py!")
